...
clean:
	rm -rf build dist venv rubikscubennnsolver.egg-info cache ida_search ida_search_via_graph ida_search_444_phase3_and_4 ida_search_666_centers_stage ida_search_666_daisy_centers ida_search_777_centers_stage ida_search_777_UD_centers_stage ida_search_777_daisy_centers my-pt-states.txt
