...
clean:
	rm -rf build dist venv rubikscubennnsolver.egg-info cache ida_search ida_search_via_graph ida_search_with_rotate ida_search_666_centers_stage my-pt-states.txt
