...
class LookupTable(object):
    ...
    def state(self):
        ...
        if self.state_type == 'all':
        ...
        elif self.state_type in ('444-edges-stage-last-four',
        ...
        elif self.state_type == '444-edges-solve-last-six':
            ...
            if len(paired) == 24:
                ...
                # The unpaired edges must be re-mapped to LL, FF, RR, BB, UU and DD as those were the
                # edges used to build the lookup table. Figure out which pair will be
                # the LL, which will be the RR, etc
                new_LL = None
                new_FF = None
                ...
                for (pos1, pos2) in ((28, 41), (24, 37), (40, 53), (44, 57), (56, 69), (60, 73), (72, 21), (76, 25), (2, 67), (3, 66), (14, 34), (15, 35)):
                    ...
                    if new_UU is None:
                        new_UU = (pos1_state, pos2_state)
                        continue
                    if (pos1_state, pos2_state) == new_UU or (pos2_state, pos1_state) == new_UU:
                        continue

                    if new_DD is None:
                        new_DD = (pos1_state, pos2_state)
                        continue
                    if (pos1_state, pos2_state) == new_DD or (pos2_state, pos1_state) == new_DD:
                        continue

                    raise SolveError("should not be here")
                ...
                for (pos1, pos2) in ((28, 41), (24, 37), (40, 53), (44, 57), (56, 69), (60, 73), (72, 21), (76, 25), (2, 67), (3, 66), (14, 34), (15, 35)):
                    ...
                    elif pos1_pos2_state == new_UU or pos2_pos1_state == new_UU:
                        self.parent.state[pos1] = 'U'
                        self.parent.state[pos2] = 'U'

                    elif pos1_pos2_state == new_DD or pos2_pos1_state == new_DD:
                        self.parent.state[pos1] = 'D'
                        self.parent.state[pos2] = 'D'

                    else:
                        raise SolveError("%s not in new_LL %s, new_FF %s, new_RR %s, new_BB %s, new_UU %s, new_DD %s" %
                            (pformat(pos1_pos2_state), pformat(new_LL), pformat(new_FF), pformat(new_RR), pformat(new_BB), pformat(new_UU), pformat(new_DD)))
    ...
    def solve(self):
        ...
        while True:
            ...
            if not steps:
                raise SolveError("%s: state %s does not have steps" % (self.filename, state))
