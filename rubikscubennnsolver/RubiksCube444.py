...
class RubiksCubeTsai444(RubiksCube444):
    ...
    def lt_init(self):
        ...
        3 steps has 1607 entries (0 percent, 9.80x previous step)
        4 steps has 12424 entries (0 percent, 7.73x previous step)
        5 steps has 73526 entries (4 percent, 5.92x previous step)
        6 steps has 304104 entries (17 percent, 4.14x previous step)
        7 steps has 764116 entries (43 percent, 2.51x previous step)
        8 steps has 569112 entries (32 percent, 0.74x previous step)
        9 steps has 17332 entries (0 percent, 0.03x previous step)
        ...
        3 steps has 1172 entries (0 percent, 8.75x previous step)
        4 steps has 8111 entries (0 percent, 6.92x previous step)
        5 steps has 48797 entries (2 percent, 6.02x previous step)
        6 steps has 235983 entries (13 percent, 4.84x previous step)
        7 steps has 707138 entries (40 percent, 3.00x previous step)
        8 steps has 697732 entries (40 percent, 0.99x previous step)
        9 steps has 43320 entries (2 percent, 0.06x previous step)
        ...
        3 steps has 2544 entries (0 percent, 13.18x previous step)
        4 steps has 31922 entries (0 percent, 12.55x previous step)
        5 steps has 395150 entries (7 percent, 12.38x previous step)
        6 steps has 4875527 entries (91 percent, 12.34x previous step)
        ...
        self.lt_phase3_tsai = LookupTableIDA(self,
                                             ...
                                             # prune tables
                                             (self.lt_ULFRBD_centers_solve,
                                              self.lt_UFBR_edges_solve,
                                              self.lt_ULRF_edges_solve,
                                              self.lt_DFBR_edges_solve,
                                              self.lt_DLRF_edges_solve),
                                             max_depth=6,
                                             modulo=12287383)
    ...
    def group_centers_guts(self):
        ...
        # Testing the prune tables
        #self.lt_UFBR_edges_solve.solve()
        #self.lt_ULRF_edges_solve.solve()
        #self.lt_DFBR_edges_solve.solve()
        #self.lt_DLRF_edges_solve.solve()
        #self.print_cube()
        #sys.exit(0)
    ...
    def group_edges(self):
        ...
        if self.get_non_paired_edges():
            raise SolveError("Edges should be paired")
        else:
            self.solution.append('EDGES_GROUPED')
