...
class RubiksCube555(RubiksCube):
    ...
    def pair_last_four_edges_555(self, pre_solution_len, pre_non_paired_wings_count):
        ...
        log.warning("pair_last_four_edges_555() paired %d wings in %d moves (%d left to pair, edge sol len %d)" %
            (wings_paired,
