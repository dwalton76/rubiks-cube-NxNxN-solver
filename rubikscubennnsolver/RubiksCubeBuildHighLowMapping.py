    ...
    def high_low_state(self, x, y, state_x, state_y, wing_str):
        ...
        if wing_str.startswith('U'):
            ...
            if self.state[high_edge_index] == 'U':
                ...
                raise Exception("U edge something went wrong, (%s, %s) was originally (%s, %s), moved to %s, high_index state[%s] is %s, low_index state[%s] is %s" %
            ...
            if self.state[high_edge_index] == 'L':
                ...
                self.print_cube()
                self.print_cube_layout()
                raise Exception("L edge something went wrong, (%s, %s) was originally (%s, %s), moved to %s, high_index state[%s] is %s, low_index state[%s] is %s" %
                    (x, y, state_x, state_y, wing_str, high_edge_index, self.state[high_edge_index], low_edge_index, self.state[low_edge_index]))
            ...
            if self.state[high_edge_index] == 'R':
                ...
                self.print_cube()
                self.print_cube_layout()
                raise Exception("R edge something went wrong, (%s, %s) was originally (%s, %s), moved to %s, high_index state[%s] is %s, low_index state[%s] is %s" %
                    (x, y, state_x, state_y, wing_str, high_edge_index, self.state[high_edge_index], low_edge_index, self.state[low_edge_index]))
            ...
            if self.state[high_edge_index] == 'D':
                ...
                self.print_cube()
                self.print_cube_layout()
                raise Exception("D edge something went wrong, (%s, %s) was originally (%s, %s), moved to %s, high_index state[%s] is %s, low_index state[%s] is %s" %
                    (x, y, state_x, state_y, wing_str, high_edge_index, self.state[high_edge_index], low_edge_index, self.state[low_edge_index]))
        else:
            raise Exception("invalid wing_str %s" % wing_str)
